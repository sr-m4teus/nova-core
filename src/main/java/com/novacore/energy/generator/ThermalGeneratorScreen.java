...
public class ThermalGeneratorScreen extends AbstractContainerScreen<ThermalGeneratorMenu> {
    ...
    private static final int BURN_COLOR = 0xFFE06010;
    private static final int BURN_BG_COLOR = 0xFF404040;
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        int burnX = leftPos + 80;
        int burnY = topPos + 20;
        int burnHeight = 14;
        graphics.fill(burnX, burnY, burnX + 18, burnY + burnHeight, BURN_BG_COLOR);
        int totalBurn = menu.totalBurnTicks();
        int filled = totalBurn > 0 ? burnHeight * menu.burnTicksRemaining() / totalBurn : 0;
        graphics.fill(burnX, burnY + burnHeight - filled, burnX + 18, burnY + burnHeight, BURN_COLOR);
